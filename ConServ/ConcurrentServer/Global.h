...
const char* nnapme = "nap";				//имя именованного канала, используемое ConsolePipe
const char* ucall = "nap";				//позывной сервера, используемый ResponseServer
